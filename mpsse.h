...
#ifndef __LINUX_MPSSE_H
#define __LINUX_MPSSE_H
...
/*
 * struct mpsse_ops - FT232H interface operations for upper drivers
 *
...
extern int mpsse_get_model(struct usb_interface *intf);
extern int mpsse_get_numgpio(struct usb_interface *intf);
#endif /* __LINUX_MPSSE_H */
